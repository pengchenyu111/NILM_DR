...
for idx, app in enumerate(appliances_train_df_list):
    ...
    checkpoint = ModelCheckpoint(
        './model_trained/time_offset/no_aggregate/{}_{}.tf'.format(target_appliances[idx], abnormal_rate),
    ...
    model.summary()
    model.save_weights(
        './model_trained/time_offset/no_aggregate/{}_{}.h5'.format(target_appliances[idx], abnormal_rate))
...
for idx_t, app in enumerate(target_appliances):
    model.load_weights('./model_trained/time_offset/no_aggregate/{}_{}.tf'.format(app, abnormal_rate))
